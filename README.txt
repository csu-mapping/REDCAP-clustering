...
X,Y are the x- and y- coodinates of the points or sites, and Z1, Z2, ... are the survey variable values at the sites. Each row represent a point in space. The line numbers are the total number of points (or elements) in data.
...
where RegionIDX contains the heriarchical clustering results with size(points,1)-1 to 2 clusters. You can select the optimal clustering results with SIL index or you need.
